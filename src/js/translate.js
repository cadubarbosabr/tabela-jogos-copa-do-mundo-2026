export const translations = {
    pt: {
        ...
        knockoutRadialMode: "Radial",
        knockoutRadialHint: "Arraste para girar a trilha radial e explorar o caminho das seleções.",
        fifaBadgeText: "FIFA",
    ...
    en: {
        ...
        knockoutRadialMode: "Radial",
        knockoutRadialHint: "Drag to rotate the radial path and explore the teams' journey.",
        fifaBadgeText: "FIFA",
