...
// Source: FIFA Regulations for the FIFA World Cup 26, Annex C (authoritative)
// 495 combinations of 8 qualifying third-place groups × 8 match slots
//
// Key:   8 qualifying third-place group letters sorted alphabetically
//        e.g. 'BDEFIJKL' for groups B, D, E, F, I, J, K, L
// Value: object mapping winner-slot → group of third-place opponent
//        e.g. {'1E':'D'} means 3rd place of group D faces winner of group E

// @type {Object.<string, {'1A':string,'1B':string,'1D':string,'1E':string,'1G':string,'1I':string,'1K':string,'1L':string}>}
